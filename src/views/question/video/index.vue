  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      >
        ...
        <el-table-column label="警方提醒" prop="analysis"> </el-table-column>
...
export default {
  ...
  methods: {
    ...
    // 获取列表
    async getList() {
      const res = await baseService.post("exam/api/video/list", this.requestForm);
    ...
    async deleteFn(val) {
      try {
        await baseService.post("exam/api/video/delete", { id: val.id });
        this.$notify({
          title: "删除成功",
          type: "success",
          duration: 2000
